...
public class PruebaAtletas {
    public static void main(String[] args) {
        ...
        /*Iterator it = grupoAtletas.getDorsalAnterior(45).iterator();
        while(it.hasNext()){
            System.out.println(""+it.next());*/
        grupoAtletas.imprimir();
        
        System.out.println("Dorsal mayor:"+grupoAtletas.getDorsalMayor());
        System.out.println("Dorsal menor:"+grupoAtletas.getDorsalMenor());
        }
