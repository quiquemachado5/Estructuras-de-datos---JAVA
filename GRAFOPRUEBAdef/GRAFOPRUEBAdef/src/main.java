...
public class main {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        String sCadena, s = new String(); //Declaro e inicializo las variables cadena que usaré //NO INICIALIZAR CON NULOS. MEJOR: String sCadena =  new String(); / s = new String();
        char[] saa = null; //Declaro e inicializo el vector de char donde guardaré cada letra o símbolo //Inicializar array aunque no sepamos longitud
        ...
        if (saa != null) {
            ...
            camino.calcularDistanciaMasCorta();
            camino.printResult(); //Imprimo el resultado
        }else{
            System.err.println("Hubo un problema al rellenar el vector saa y no se puede ejecutar el programa.");
        }
    }
